...
| Workflow              | **solo only, never prompted**                                       | `team` defaults to `audit: true` ([resolver.ts:31](packages/glaze-cms/config/resolver.ts:31)), and an audited change currently pends **and rolls back** ([engine.ts:153](packages/glaze-cms/convergence/orchestrator/engine.ts:153)) until pending approvals land ([pending-approvals.md](./pending-approvals.md)). Scaffolding `team` would hand someone a project whose schema changes never apply.                                                                                                                         |
